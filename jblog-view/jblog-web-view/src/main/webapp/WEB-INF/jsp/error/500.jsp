...
<%-- 
  ...
  - Description: HTTP status codes 500. Internal Server Error.
  --%>
...
<body>
    <div class="centerBlock">
        ...
        <div class="body">
            <p>An error occurred on the server, try to repeat the action later. If the error persists, contact the administrator.</p>
